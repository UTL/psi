...
public class TreeTransferHandler extends TransferHandler {
    ...
    public boolean canImport(TransferSupport support)	{
    	//controlli per verificare se il drop � valido
    	//1. se l'operazione non � di drop allora ritorna false
    	if (!support.isDrop())	{
    	...
    	//3. se il data flavor non � supportato allora ritorna false
        if (!support.isDataFlavorSupported(nodesFlavor)) {
        	System.out.println("Tipo non supportato");
            return false;
        }
        //4a. se la DropLocation � la stessa della DragLocation ritorna false
        //4b. se la DropLocation e la DragLocation sono entrambi elementi composti
        //4c. se la DragLocation � la root
        ...
        //5. se la DropLocation � un componente che non permette figli
    ...
    protected Transferable createTransferable(JComponent c)	{
    	JTree tree = (JTree) c;
    	/**
    	 * TODO Modificare per creare la copia di un singolo elemento se � un componente semplice, o la copia di tutti i suoi figli se � complesso
    	 */
