...
public class MainWindow extends JFrame {
	...
	private static final String[] categorie = { "Necessary", "Indifferent",
			"Expendable" }; // FIXME Andrebbero rese globali per tutte le
							// classi??
	...
	public MainWindow() {
		...
		properties.setBorder(new TitledBorder(new LineBorder(new Color(184,
				207, 229)), " Properties ", TitledBorder.LEADING,
	...
	private void updateLinkText() {
		...
		// TODO sarebbe bello sollevare un'eccezione ogni volta che questo if
		// non si verifica (e anche per tutti gli altri metodi di update)
	}
