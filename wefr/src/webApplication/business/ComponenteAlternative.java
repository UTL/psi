...
public class ComponenteAlternative extends Componente implements Serializable{
    ...
    /**
     *
     * @return vettore di componenti semplici che costituiscono le varie alternative
     */
     ...
     *
     * @param posizione
     * @return l'alternativa che si trova alla posizione chiesta all'interno del vettore
     */
